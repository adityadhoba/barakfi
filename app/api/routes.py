...
def check_stock(
    ...
    """
    Quick screening summary: product labels (Halal / Doubtful / Haram), consensus score, one line.

    Auth: None (public). Uses four-methodology consensus (same engine as /screen/{symbol}/multi).
    """
