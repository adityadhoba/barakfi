      ...
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.prose}>
            ...
            recommendations, or portfolio management services. The screening results displayed
            on this platform are generated by automated algorithms and should not be construed
        ...
        <section className={styles.section}>
          ...
          <div className={styles.warningBox}>
            <p>
              ...
              screening data, compliance trends, and stock performance shown on this platform
        ...
        <section className={styles.section}>
          ...
          <p className={styles.prose}>
            The regulatory environment for fintech platforms in India is evolving. SEBI, RBI,
        ...
        <section className={styles.section}>
          ...
          <p className={styles.prose}>
            ...
            on this platform does not constitute an endorsement, guarantee, or recommendation
