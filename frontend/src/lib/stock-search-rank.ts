/**
 * Rank stocks for autocomplete: best match first (exact ticker, prefix, then name, then sector).
 */
...
/** Split text into alternating match / non-match segments (case-insensitive). */
